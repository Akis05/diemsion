  ...
  return (
    <div class="relative inline-flex ml-3">
      ...
      >
        ...
        >
          <div class="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-4">Need help?</div>
          <ul>
            <li>
              <a
              ...
              >
                ...
                <span>   <svg class="w-3 h-3 fill-current text-indigo-300 shrink-0 mr-2" viewBox="0 0 12 12">
