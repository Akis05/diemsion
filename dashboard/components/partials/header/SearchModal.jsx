      ...
      >
        <div ref={modalContent} class="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
          ...
          <form class="border-b border-slate-200">
            <div class="relative">
              <label htmlFor={searchId} class="sr-only">Search</label>
                ...
                <li>
                  ...
                  >
                    ...
                    <span>
                      ...
                      <span class="font-medium text-slate-800 group-hover:text-white">Messages</span> - Conversation / … / Mike Mills</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span>
                      ...
                      <span class="font-medium text-slate-800 group-hover:text-white">Messages</span> - Conversation / … / Eva Patrick</span>
                  </a>
                </li>
              </ul>
            </div>
