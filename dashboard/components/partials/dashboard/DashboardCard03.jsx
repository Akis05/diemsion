      ...
      <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
          ...
          <EditMenu class="relative inline-flex">
            <li>
              <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href="  /#">Option 1</a>
            </li>
            <li>
              <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href="  /#">Option 2</a>
            </li>
            <li>
              <a class="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3" href="  /#">Remove</a>
            </li>
          </EditMenu>
        </header>
